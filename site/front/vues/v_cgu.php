...
<section class="container mt-2">
    ...
    <p>Conformément aux dispositions des Articles 6-III et 19 de la Loi n°2004-575 du 21 juin 2004 pour la Confiance dans l'économie numérique, dite L.C.E.N., il est porté à la connaissance des utilisateurs et visiteurs du site <u><a href="https://chocolatin.gil83.fr">chocolatin.gil83.fr</a></u> les présentes mentions légales.</p>
    <p>Le site Chocolate'In est accessible à l'adresse suivante&nbsp;:&nbsp;<u><a href="https://chocolatin.gil83.fr">chocolatin.gil83.fr</a></u> (ci-après "<i>le site</i>"). L'accès et l'utilisation du Site sont soumis aux présentes "Mentions légales" détaillées ci-après ainsi qu'aux lois et/ou règlements applicables. La connexion, l'utilisation et l'accès à ce site impliquent l'acceptation intégrale et sans réserve de l'internaute de toutes les dispositions des présentes Mentions Légales.</p>
    ...
    <div class="bd-example">
        <details>
            ...
            <address>
                <strong>Loupita Hernandez</strong>
                <br>Avenue Winston Churchill
                <br>83000 Toulon
                <br>Téléphone&nbsp;:&nbsp;0102030405
                <br>Courriel&nbsp;:&nbsp;contact@chocolatin.gil83.fr
                <br>RCS&nbsp;:&nbsp;234567891
            </address>
        </details>
        <details>
            <summary>B. Directeur de publication (ci-après "<i>le Directeur de publication</i>")</summary>
            <address>
                <strong>Myriam LATCOCHO</strong>
                <br>Courriel&nbsp;:&nbsp;directpub@chocolatin.gil83.fr
            </address>
        </details>
        <details>
            <summary>C. Hébergeur du site (ci-après "<i>l'Hébergeur</i>")</summary>
            <address>
                <strong>OVH SAS</strong>
                <br>2 rue Kellermann
                <br>BP 80157
                <br>59100 Roubaix
                <br>Téléphone&nbsp;:&nbsp;0320200958
                <br>Courriel&nbsp;:&nbsp;contact@ovh.net
            </address>
        </details>
        <details>
            <summary>D. Utilisateurs (ci-après "<i>les Utilisateurs</i>")</summary>
            <p>Sont considérés comme utilisateurs tous les internautes qui naviguent, lisent, visionnent et utilisent le site Chocolate'In.</p>
        </details>
    </div>
    <h2 class="mt-3">Article 2 - Confidentialité</h2>
    <div class="bd-example">
        <details>
            <summary>A. Données collectées et traitées</summary>
            ...
            <p>Les données à caractère personnel collectées sur le site Chocolate'In sont les suivantes :</p>
            <ul>
                <li>Nom</li>
                <li>Prénom</li>
            ...
            <ul>
                <li>Contacte le service client de Chocolate'In par tout moyen de communication mis à sa disposition tel que le courrier électronique, l'utilisation du formulaire de contact...</li>
                <li>Inscription à l'infolettre de Chocolate'In.</li>
            </ul>
        ...
        <details>
            <summary>B. Hébergement des données</summary>
            <p>Tel que mentionné plus haut, le site Chocolate'In est hébergé par&nbsp;:&nbsp;OVH SAS, dont le siège est situé à l'adresse suivante&nbsp;: 2 rue Kellermann - BP 80157, 59100 Roubaix.</p>
        ...
        <details>
            <summary>C. Le responsable du traitement des données</summary>
            <p>La responsable du traitement des données à caractère personnel est&nbsp;:&nbsp;Loupita Hernandez. Elle peut être contactée par téléphone au 01.02.03.04.05, de 8h à 19h, du lundi au vendredi.</p>
        </details>
        <details>
            <summary>D. Le délégué à la proctection des données</summary>
            <p>La personne suivante a été nommée Déléguée à la Protection des Données&nbsp;:&nbsp;Loupita Hernandez.</p>
            <p>La déléguée à la protection des données peut être joint par téléphone au 06.80.80.80.90, du lundi au vendredi de 9h à 17h ou par mail&nbsp;:&nbsp;dpo@chocolatin.gil83.fr.</p>
        </details>
        <details>
            <summary>E. Données personnelles des personnes mineures</summary>
        ...
        <details>
            <summary>F. Droits de l'utilisateur et procédures de mise en oeuvre des droits de l'utilisateur</summary>
            ...
            <details>
                <summary>a. Droit d'accès, de rectification et droit à l'oubli</summary>
            ...
            <details>
                <summary>b. Droit à la portabilité des données</summary>
            ...
            <details>
                <summary>c. Droit à la limitation et à l'opposition du traitement des données</summary>
            ...
            <details>
                <summary>d. Droit de déterminer le sort des données après la mort</summary>
            ...
            <details>
                <summary>e. Droit de saisir l'autorité de contrôle compétente</summary>
        ...
        <details>
            <summary>G. Obligations du responsable du traitement des données</summary>
        ...
        <details>
            ...
            <details>
                <summary>a. Opposition de l'utilisateur à l'utilisation de fichiers "cookies" par le site</summary>
            ...
            <details>
                <summary>b. Description des fichiers "cookies" utilisés par le site</summary>
    ...
    <h2 class="mt-3">Article 3 - accessibilité</h2>
    ...
    <h2 class="mt-3">Article 4 - loi applicable et juridiction</h2>
    ...
    <h2 class="mt-3">Article 5 - contact</h2>
    <p>Pour tout signalement de contenus ou d'activités illicites, l'Utilisateur peut contacter l'Éditeur à l'adresse suivante&nbsp;:&nbsp;contact@chocolatin.gil83.fr, ou par courrier recommandé avec accusé de réception adressé à l'Éditeur aux coordonnées précisées dans les présentes mentions légales.</p>
    <p>Le site Chocolate'In vous souhaite une excellente navigation !</p>
</section>