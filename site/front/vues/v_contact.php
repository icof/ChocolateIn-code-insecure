            ...
            <div class="form-group col-md-8 mx-auto">
                <div class="input-group mb-3">
                    ...
                    <select class="custom-select" name="statut" id="statut" aria-describedby="labelstatut">
                        <option value="Particulier" <?php if ($statut === "Particulier") {
                                                        echo 'selected';
                                                    } ?>>Particulier</option>
                        <option value="Entreprise" <?php if ($statut === "Entreprise") {
                                                        echo 'selected';
                                                    } ?>>Entreprise</option>
                        <option value="Comité d'entreprise (CE)" <?php if ($statut === "Comité d'entreprise (CE)") {
                                                                        echo 'selected';
                                                                    } ?>>Comité d'entreprise (CE)</option>
                        <option value="Collectivité locale" <?php if ($statut === "Collectivité locale") {
                                                                echo 'selected';
                                                            } ?>>Collectivité locale</option>
                        <option value="École" <?php if ($statut === "École") {
                                                    echo 'selected';
                                                } ?>>École</option>
                        <option value="Autres" <?php if ($statut === "Autres") {
                                                    echo 'selected';
                                                } ?>>Autres</option>
                    </select>
                </div>
