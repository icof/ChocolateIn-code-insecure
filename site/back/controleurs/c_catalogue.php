...
if (isset($_POST['id']) && ($_POST['id'] != "")) {
    // sécurisation contre les injections XSS par une approche de type assainissement
    $idGammeSelected = htmlspecialchars($_POST['id']);
}
// appel des fonctions permettant de recuperer les donnees utiles a l'affichage 
$lesGammes = getGammes();

// sécurisation contre les injections XSS par une approche de type prédictive
$gammesPermises = array();
foreach ($lesGammes as $gamme) {
    $gammesPermises[] = $gamme['id'];
}

// traitement si necessaire des donnees recuperees
if (isset($idGammeSelected) && in_array($idGammeSelected, $gammesPermises)) {
